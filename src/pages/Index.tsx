    ...
    for (const file of fArray) {
      try {
        ...
        if (!ext) {
          extratos.push({
            fileName: file.name,
            extract: { municipio: "", deducao: "", Aliquota: "", tomador: "", numero: "", erro: "Erro ao ler campos do XML" },
          });
          continue;
        }
        ...
        extratos.push({ fileName: file.name, extract: { municipio: "", deducao: "", Aliquota: "", tomador: "", numero: "", erro: "Falha ao processar arquivo" } });
      }
    }
              ...
              >
                ...
                {extract.erro ? (
                  ...
                  <ul className="grid gap-1 text-sm">
                    ...
                    <li><span className="font-medium">Valor ISS:</span> {extract.Aliquota}</li>
